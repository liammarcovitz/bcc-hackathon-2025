  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100vh", backgroundColor: "#f3f4f6", padding: "20px", position: "relative" }}>
      ...
      <div style={{ display: "flex", gap: "15px" }}>
        {[
          ...
          <div 
            ...
            style={{ padding: "15px", border: `2px solid ${selectedOption === option.type ? "#3b82f6" : "#d1d5db"}`, borderRadius: "8px", cursor: "pointer", backgroundColor: "white", boxShadow: "0px 4px 6px rgba(0, 0, 0, 0.1)", width: "200px", textAlign: "center" }}
          >
      ...
      <button 
        ...
        style={{ marginTop: "20px", padding: "10px 15px", backgroundColor: selectedOption ? "#3b82f6" : "#9ca3af", color: "white", border: "none", borderRadius: "4px", cursor: selectedOption ? "pointer" : "not-allowed" }}
      >
